...
function updateTime(start){
    ...
    let miliseconds = Math.floor((passedTime / 100) % 10);
    (miliseconds < 10 ) ? miliseconds = "0"+miliseconds :  toString(miliseconds);
    ...
    (minutes < 10) ? minutes = "0"+minutes : toSztring(minutes);
